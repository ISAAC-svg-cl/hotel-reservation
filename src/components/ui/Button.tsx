...
export function Button({
  ...
  const variants = {
    primary:
      "bg-amber-600 hover:bg-amber-500 text-white shadow-lg shadow-amber-900/20 focus:ring-amber-500",
    secondary:
      "bg-slate-900 hover:bg-slate-800 text-white border border-slate-700 focus:ring-slate-700",
    outline:
      "border border-slate-300 dark:border-slate-700 bg-transparent hover:bg-slate-100 dark:hover:bg-slate-800 text-slate-900 dark:text-slate-100 focus:ring-slate-500",
    ghost:
